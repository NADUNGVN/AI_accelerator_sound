...
class EfficientAudioCNN1D(nn.Module):
    """
    Low-parameter, low-MAC 1D-CNN for 4s raw UrbanSound8K clips.

    The model is intended for the proposed-improvement track, not strict paper
    reproduction. It processes a full 4-second waveform in one pass so inference
    avoids the 15-frame SUM loop used by TCAM1DCNN.
    """
