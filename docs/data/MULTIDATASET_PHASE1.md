...
**Status:** initial loader/config support is present. ESC-50 and Speech Commands accuracy is not reportable until dataset availability, split fingerprints, smoke runs, and server metrics are committed.
...
Do not compare `esc50_3_1_1_foldk_valnext_v1` directly to papers that report `esc50_official_4_1_cv`; the training data and checkpoint-selection rule differ.
